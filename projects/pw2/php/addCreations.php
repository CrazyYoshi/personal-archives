...
$form .= "                  <input type=\"text\" name=\"srcurl\"   requiredNO=\"requiredNO\" value=\"/assets/portfolio/\" placeholder=\"LIEN\"/><br/>";
$form .= "                  <input type=\"text\" name=\"pvwurl\"  requiredNO=\"requiredNO\" value=\"/assets/portfolio/\" placeholder=\"Preview/LIEN\"/><br/>";
...
if (isset($_POST['submit'])){
    ...
    $directory = $directorySRC = $directoryPreview = "../assets/portfolio/";
    $srcOk = false;
    $pvwOk = false;

    if($_POST['srcurl']=='/assets/portfolio/'){
        unset($_POST['srcurl']);
        echo "<br/>Cleaned source Url";
    }
    if($_POST['pvwurl']=='/assets/portfolio/'){
        unset($_POST['pvwurl']);
